...
def parse_args() -> Namespace | None:
    try:
        ...
        parse.add_argument("--key", "-k", nargs="+", type=str, help="--key <keyword>")
        ...
        parse.add_argument("--board", "-b", nargs="+", type=str, help="--board <board_name>")
        parse.add_argument("-T", type=int, default=30, help="-T <n>")
